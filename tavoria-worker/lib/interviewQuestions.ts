...
const RIDER: InterviewQuestion[] = [
  {
    id: "ri1",
    role: "Rider",
    text: "You arrive with the delivery and the customer's address is wrong / not findable. What do you do?",
    options: [
      { id: "a", text: "Call the customer immediately, calmly ask for a landmark" },
      { id: "b", text: "Try the nearest matching address, knock and ask" },
      { id: "c", text: "Leave the order and notify the platform" },
      { id: "d", text: "Wait at the pinned location, message the customer" },
      { id: "e", text: "Take the order back to the venue" },
    ],
  },
  {
    id: "ri2",
    role: "Rider",
    text: "The order is hot food and you've been stuck in traffic for 25 minutes. What do you do?",
    options: [
      { id: "a", text: "Message the customer with an honest ETA, apologize" },
      { id: "b", text: "Push through faster, ignore the delay" },
      { id: "c", text: "Notify the venue so they can update their record" },
      { id: "d", text: "Find an alternate route, even if longer in km" },
      { id: "e", text: "Cancel and return to venue" },
    ],
  },
  {
    id: "ri3",
    role: "Rider",
    text: "You arrive and realise an item is missing from the bag. What do you do?",
    options: [
      { id: "a", text: "Tell the customer honestly, give the venue's number" },
      { id: "b", text: "Hand it over and don't mention it" },
      { id: "c", text: "Call the venue, ask how to handle it on the spot" },
      { id: "d", text: "Offer to ride back and bring the missing item" },
      { id: "e", text: "Refund the missing item via the app right there" },
    ],
  },
  {
    id: "ri4",
    role: "Rider",
    text: "It starts raining hard mid-shift and you don't have a rain cover. What do you do?",
    options: [
      { id: "a", text: "Keep going — protect the food bag with your jacket" },
      { id: "b", text: "Stop somewhere safe, message customer + venue with delay" },
      { id: "c", text: "End the shift early — safety first" },
      { id: "d", text: "Buy a poncho at the nearest shop and continue" },
      { id: "e", text: "Ignore it, finish the delivery as fast as possible" },
    ],
  },
  {
    id: "ri5",
    role: "Rider",
    text: "Your bike breaks down with a hot order on board. What do you do?",
    options: [
      { id: "a", text: "Call the venue immediately, ask them to reassign or guide" },
      { id: "b", text: "Walk the remaining distance if it's under 1 km" },
      { id: "c", text: "Call the customer, explain, ask for patience" },
      { id: "d", text: "Try to fix the bike fast, then resume" },
      { id: "e", text: "Leave the order somewhere safe and walk home" },
    ],
  },
];
